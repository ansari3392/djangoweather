...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=11F68D5A-E35A-4767-A981-E4976EE3E472")
        ...
        if api[0]['Category']['Name'] == "Good":
            ...
            category_color = "unhealthyforsensitivegroup"
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=11F68D5A-E35A-4767-A981-E4976EE3E472")
